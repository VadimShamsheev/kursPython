...
urlpatterns = [
    ...
    path('edit_order.html/<int:order_id>', EditOrder.as_view()),
    path('customer_page.html', CustomerPage.as_view()),
    path('edit_service.html/<int:service_id>', EditService.as_view()),
